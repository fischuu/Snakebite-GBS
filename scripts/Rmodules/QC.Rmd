...
if(libtype=="PE") conFastQC.R2 <- read.table(file.path(projFolder,"QC","CONCATENATED","multiqc_R2","multiqc_data","multiqc_fastqc.txt"), header=TRUE, sep="\t")
conFastQCJSON.R1 <- getFastQCJSON(file.path(projFolder, "QC", "CONCATENATED", "multiqc_R1", "multiqc_data", "multiqc_data.json"))
if(libtype=="PE") conFastQCJSON.R2 <- getFastQCJSON(file.path(projFolder, "QC", "CONCATENATED", "multiqc_R2", "multiqc_data", "multiqc_data.json"))
...
if(libtype=="PE") trimmedFastQC.R2 <- read.table(file.path(projFolder,"QC","TRIMMED","multiqc_R2","multiqc_data","multiqc_fastqc.txt"), header=TRUE, sep="\t")
trimmedFastQCJSON.R1 <- getFastQCJSON(file.path(projFolder, "QC", "TRIMMED", "multiqc_R1", "multiqc_data", "multiqc_data.json"))
if(libtype=="PE") trimmedFastQCJSON.R2 <- getFastQCJSON(file.path(projFolder, "QC", "TRIMMED", "multiqc_R2", "multiqc_data", "multiqc_data.json"))
```
...
if(libtype=="PE"){
  ...
  plotFastQCFeature(conFastQC.R1,  feature="total_deduplicated_percentage", axes=FALSE)
}
...
if(libtype=="PE"){
  ...
  plotFastQCFeature(conFastQC.R1, feature="X.GC", axes=FALSE)
}
abline(h=50, lty="dotted", col="red")
abline(h=35, lty="dotted", col="red")
```
...
if(libtype=="PE"){
  ...
  plotFastQCFeature(conFastQC.R1, feature="avg_sequence_length", axes=FALSE)
}
...
if(libtype=="PE"){
  ...
  plotFastQCFeature(conFastQC.R1, feature="Total.Sequences")
}
```
...
Please note, in case of SE libraries both plots show the results for R1.
...
if(libtype=="PE"){
  ...
  plotMQCFeature(x=file.path(projFolder,"QC","CONCATENATED","multiqc_R1"),
                   y=file.path(projFolder,"QC","CONCATENATED","multiqc_R1"),
                   feature="fastqc_per_base_n_content_plot")
...
if(libtype=="PE"){
  ...
  plotFastQCFeature(trimmedFastQC.R1, feature="total_deduplicated_percentage", axes=FALSE)
  abline(h=20, lty="dotted", col="red")
...
if(libtype=="PE"){
  ...
  plotFastQCFeature(trimmedFastQC.R1, feature="X.GC", axes=FALSE)
  abline(h=50, lty="dotted", col="red")
  abline(h=35, lty="dotted", col="red")
}
```
...
if(libtype=="PE"){
  ...
  plotFastQCFeature(trimmedFastQC.R1, feature="avg_sequence_length", axes=FALSE)
  tmp <- trimmedFastQC.R1["avg_sequence_length"]
  tmp <- mean(as.vector(as.matrix((tmp)))) 
  abline(h=tmp*0.9, lty="dotted", col="red")
}
...
if(libtype=="PE"){
  ...
  plotFastQCFeature(trimmedFastQC.R1, feature="Total.Sequences")
}
```
...
Please note, in case if SE-libraries both plots are identical and show R1.
...
if(libtype=="PE"){
  ...
  conFastQC.avg <- conFastQC.R1[,-c(1:4,7,11:21)]
  trimmedFastQC.avg <- trimmedFastQC.R1[,-c(1:4,7,11:21)]
  conFastQC.avg$Sample <- conFastQC.R1$Sample
  trimmedFastQC.avg$Sample <- trimmedFastQC.R1$Sample
