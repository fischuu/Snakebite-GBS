...
Now we will check how the reads from different samples distribute across the indivisual aligned loci (which have been merged together). Idially, we want to see here that all samples have reads from all mapping loci, which is of course not possible but there should be "some consistency".
...
Basic visualisation, binary, if a sample has reads on a locus we plot it dar red, otherwise light yellow. Ideally, this is now just a red block.
