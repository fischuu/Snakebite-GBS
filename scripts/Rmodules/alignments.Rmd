...
Now we check still the precise coverage per sample for the sake of simplicity I do it here for the first three samples only and also only for the first 50  chromosomes
...
pdf(file.path(projFolder,"coverage.pdf"), width=20, height=10)
