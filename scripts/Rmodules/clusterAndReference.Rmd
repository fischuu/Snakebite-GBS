...
The preliminary mock reference is created inthe first phase of the GBS pipeline. Here, we first create a mock reference and then align the data to it. Then, cluster locations with low coverage are removed to avoid diluting reads across locations that were assembly artifacts rather than real mock reference clusters
...
Basic information on the identified clusters, used as preliminary mock reference
