...
if(!is.element("snakemake",ls())){
  projFolder <- "/scratch/project_2001746/Whitefish"
  pipelineFolder <- "/scratch/project_2001746/Pipeline-GBS/"
  pipelineConfig <- "/scratch/project_2001746/Whitefish/GBS-pipeline_config-whitefish.yaml"
