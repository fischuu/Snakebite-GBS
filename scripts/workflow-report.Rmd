...
if(!is.element("snakemake",ls())){
  projFolder <- "/media/fischuu/backup/LUKE/Example"
  pipelineFolder <- "/home/fischuu/git/Pipeline-GBS/"
  pipelineConfig <- "/home/fischuu/git/Pipeline-GBS/GBS-pipeline_config-example.yaml"
  refGenome.file <- ""
}
...
if(file.exists(file.path(pipelineFolder,"workflow.png"))) knitr::include_graphics(file.path(pipelineFolder,"workflow.png"))
```
